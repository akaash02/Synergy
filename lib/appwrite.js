...
export async function getAllTasks() {
  try {
    ...
    const creatorTasks = await databases.listDocuments(
      appwriteConfig.databaseId,
      appwriteConfig.tasksCollectionId,
      [Query.equal("Creator", currentUser.accountId)]
    );
    ...
    const assigneeTasks = await databases.listDocuments(
      appwriteConfig.databaseId,
      appwriteConfig.tasksCollectionId,
      [Query.search("Assignees", currentUser.accountId)]
    );

    // Merge and return unique tasks
    const allTasks = [
      ...creatorTasks.documents,
      ...assigneeTasks.documents,
    ];
